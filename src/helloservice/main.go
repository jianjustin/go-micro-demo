...
import (
	"context"
	"github.com/go-micro/demo/helloservice/config"
	"github.com/go-micro/demo/helloservice/handler"
...
func main() {
	...
	// Register handler
	if err := pb.RegisterHelloserviceHandler(srv.Server(), new(handler.Helloservice)); err != nil {
		logger.Fatal(err)
	}
